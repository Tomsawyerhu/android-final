...
public class VideoPlayerLoader extends ViewLoader {
    ...
    public void loadData() {
        ...
        // 加载用户名和描述
        ((TextView) this.getView().findViewById(R.id.tv_name)).setText(this.nickname);
        ((TextView) this.getView().findViewById(R.id.tv_des)).setText(this.description);
    ...
    private void loadPlayer() {
        if (this.videoUrl != null) {
            VideoPlayerManager.playerUrl = this.videoUrl;
        }
